    ...
    return (
        <div className={`${isOpen ? "-translate-x-48" : "translate-x-none"}   w-60  fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B]`}>
            ...
            <div className={`${isOpen ? "hidden" : "flex"} text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]`}>
                <NavLink to={"kurslar"} className="hover:ml-4 w-full text-white hover:text-[#0f95ee] bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
                    <HiOutlineAcademicCap />
                    <div>
                        Kurslar
                    </div>
                </NavLink>
                <NavLink to={"my-kurs"} className="hover:ml-4 w-full text-white hover:text-[#0f95ee] bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
                    <IoBookOutline />
                    <div>
                        Mening kurslarim
                    </div>
                </NavLink>
                <NavLink to={"statistic"} className="hover:ml-4 w-full text-white hover:text-[#0f95ee] bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
